...
@implementation ZXSubDoubleCell
...
//    [self.couponLabel.layer setCornerRadius:3.0];
    ...
    [self.nameLabel setPreferredMaxLayoutWidth:(SCREENWIDTH - 15.0)/2.0 - 20.0];
    [self.nameLabel setFrame:CGRectMake(10.0, 0.0, (SCREENWIDTH - 15.0)/2.0 - 20.0, self.nameView.frame.size.height)];
