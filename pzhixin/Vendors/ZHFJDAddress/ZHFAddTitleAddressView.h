...
@property (strong, nonatomic) NSString *prov_def;

@property (strong, nonatomic) NSString *city_def;

@property (strong, nonatomic) NSString *area_def;

@property (strong, nonatomic) NSString *street_def;
