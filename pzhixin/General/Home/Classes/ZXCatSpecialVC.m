...
@interface ZXCatSpecialVC () <WKUIDelegate, WKScriptMessageHandler, WKNavigationDelegate> {
...
- (void)createWkWebView {
    ...
    [_wkWebView loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:_menu.url]]];
}
